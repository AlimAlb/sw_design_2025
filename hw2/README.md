...
## Требования
- Python 3.11+
- Стандартная библиотека Python (json, csv, datetime, typing, abc, enum, dataclasses) и PyYAML

Для установки опциональных зависимостей (PyYAML):
...
Далее установка необходимых пакетов (он по сути один)
```bash
pip install -r requirements.txt
```
